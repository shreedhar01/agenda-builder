...
export const getAllAgendaItemService = async (user: { id: number, name: string }) => {
...
export const getAgendaItemByIdService = async (id: number, user: { id: number, name: string }) => {
